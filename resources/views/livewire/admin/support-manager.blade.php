<div class="p-4 bg-white rounded shadow-md max-w-lg mx-auto">
   ...
   <div class="mb-4 space-y-2">
    <p><i class="fa-solid fa-phone mr-2"></i><strong>Teléfono:</strong> +505 8868-0701</p>
    <p><i class="fa-brands fa-whatsapp mr-2"></i><strong>WhatsApp:</strong> <a href="https://wa.me/50588680701" target="_blank" class="text-blue-600">Enviar mensaje</a></p>
    <p><i class="fa-solid fa-envelope mr-2"></i><strong>Correo:</strong> <a href="mailto:soportedocly@gmail.com" class="text-blue-600">soportedocly@gmail.com</a></p>
